...
/** @type {string} */
const CACHE_VERSION = '1788097851|16291064101';
/** @type {string} */
const CACHE_PREFIX = 'SGJ_Tower_Defens-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SGJ_Tower_Defense.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SGJ_Tower_Defense.html","SGJ_Tower_Defense.js","SGJ_Tower_Defense.offline.html","SGJ_Tower_Defense.icon.png","SGJ_Tower_Defense.apple-touch-icon.png","SGJ_Tower_Defense.audio.worklet.js","SGJ_Tower_Defense.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SGJ_Tower_Defense.wasm","SGJ_Tower_Defense.pck"];
